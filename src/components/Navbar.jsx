  ...
  return (
    <div className='flex justify-between p-2 md:mx-6 relative'>
      <NavButton title="Menu" customFunc={() => 
        ...
        !prevActiveMenu)} color="royalblue" icon={<AiOutlineMenu/>} />

        <div className='flex'>
          <NavButton title="Cart" customFunc={() => 
          handleClick('cart')} 
          color="royalblue" icon={<FiShoppingCart/>} />
        
          <NavButton title="Chat" 
            dotColor="#03C9D7" customFunc={() => handleClick('chat')} color="royalblue" icon={<BsChatLeft/>} />
          <NavButton title="Notifications" 
            dotColor="#03C9D7" customFunc={() => handleClick('notification')} color="royalblue" icon={<RiNotification3Line/>} />
        <TooltipComponent
          content="Profile"
